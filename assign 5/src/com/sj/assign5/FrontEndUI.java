...
public class FrontEndUI {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("what would you like to do today - new user - enter 1; update - enter 2; delete -3, get user info -4 ");
        ...
        if (action == 2) {
            ...
            if (user == null) {
                ...
                user = userAdd(action, user);
                System.out.println("here is the updated information for User with username - "+user.getUserName());
                System.out.println(user.getFirstName()+" "+ user.getLastName() + " "+ user.getEmailAddress() + " "+ user.getPhoneNumber()+ " "+user.getAge());
    ...
    public static User userAdd(Integer action, User user) {
        ...
        if (action == 1) user.setUserName(userName);
